...
class Doctor(models.Model):
    ...
    day_slots = models.CharField(max_length=100, blank=True, help_text="e.g. 09:00–13:00")
    night_slots = models.CharField(max_length=100, blank=True, help_text="e.g. 21:00–23:00")
    slots_per_day = models.IntegerField(default=20)
    disabled_slots = models.TextField(blank=True, default='', help_text="Comma-separated HH:MM times hidden from slot grid")
